...
/** userLoginByWxMiniapp GET /api/user/login/miniapp */
export async function userLoginByWxMiniappUsingGet(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.userLoginByWxMiniappUsingGETParams,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseLoginUserVO>('/api/user/login/miniapp', {
    method: 'GET',
    params: {
      ...params,
    },
...
/** userLoginByWxMp POST /api/user/login/wx_mp */
export async function userLoginByWxMpUsingPost(
  body: API.UserLoginByWxMpRequest,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseLoginUserVO>('/api/user/login/wx_mp', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** userLoginByWxMpGetScene POST /api/user/login/wx_mp/get_scene */
export async function userLoginByWxMpGetSceneUsingPost(options?: { [key: string]: any }) {
  return request<API.BaseResponseUserLoginByWxMpGetSceneResponse>(
    '/api/user/login/wx_mp/get_scene',
    {
      method: 'POST',
      ...(options || {}),
    },
